export const meta = {
  title: 'Counting the Values, Part 2',
  series: 1,
  episode: 5,
}
...
<Answer byline="Don’t revealfurther until you have decided on an answer.">
...
As a result, both `countDwarves` and `dwarves` point to the same value, which happens to be a function. See, _functions are values_. We can point variables to them, just like we can do with numbers or objects.
...
<Pagination next="06-equality-of-values" prev="04-counting-the-values-pt1">
  Equality of Values
</Pagination>
