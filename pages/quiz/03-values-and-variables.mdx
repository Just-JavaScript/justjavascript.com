...
![A, it "eat cake", them "eat cake"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612305600/just-javascript-email-images/jj03/quiz%20images/01%20eat%20cake.png)

</Choice>

<Choice correct>

![B, variables it value "eat cake", variables them value "eat cake", values "be"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612305624/just-javascript-email-images/jj03/quiz%20images/B%20eat%20cake.png)

</Choice>

<Choice>

![C, variables it them values "eat cake", values "be"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612305642/just-javascript-email-images/jj03/quiz%20images/03%20eat%20cake.png)

</Choice>

<Choice>

![D, it them "eat cake"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612305661/just-javascript-email-images/jj03/quiz%20images/04%20eat%20cake.png)
...
Your colleague bets they can can change your `console.log` output by only editing their `feed.js` file. Do you believe them, or would you bet they can’t?

Explain your reasoninig using your mental model.
...
This is becase you can’t “pass a variable” in JavaScript, **you can only pass a _value_**. So it’s not the `pets` variable that we’re passing to `feed`. Rather, it’s _the value_ of that variable at that time, which is the `"Tom and Jerry"` string value.
...
Once again, your colleague bets they can can change the output by only editing their `feed.js` file. Do you believe them, or would you bet they can’t?
