...
![A, music links to curly brackets which links to "classical" with taste above the link between the curly brackets and "classical", onion links to curly brackets](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613066837/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-04-a.png)

</Choice>

<Choice correct>

![B, music and onion link to the same curly brackets which links to "classical" with taste above the link between the curly brackets and "classical"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613066880/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-04-b.png)
...
![A, burger links to curly brackets which links to "veggie" with beef above the link between the curly brackets and "veggie", rapper links to curly brackets which links to "legit" with beef above the link between the curly brackets and "legit"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613067962/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-07-a.png)

</Choice>

<Choice>

![B, burger and rapper link to the same curly brackets which links to "veggie" with beef above the link betwen the curly brackets and "veggie"](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613068004/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-07-b.png)
...
![A, charlotte links to curly brackets which links twice to curly brackets with child above one link and mother above the other, the second curly brackets links to 20 with age above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613068951/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-11-a.png)

</Choice>

<Choice>

![B, charlotte links to curly brackets which links to two curly brackets with child above one link and mother above the other, both curly brackets link to 20 with age above both links](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613069040/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-11-b.png)

</Choice>

<Choice>

![C, charlotte links to curly brackets which links to itself twice with child above one and mother above the other, the curly brackets also links to 20 with age above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613069095/just-javascript-email-images/jj08/Quiz%20Images/jjs-08-11-c.png)
