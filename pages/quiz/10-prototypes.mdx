...
![A, lie links to curly brackets which links to "bitter" with taste above the link, cake links to the same curly brackets](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613069618/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-01-a.png)

</Choice>

<Choice>

![B, cake links to curly brackets which links to lie with __proto__ above the link, lie links to curly brackets which links to "bitter" with taste above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613069700/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-01-b.png)

</Choice>

<Choice correct>

![C, lie links to curly brackets which links to "bitter" with taste above the link, cake links to curly brackets which links to the first curly brackets with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613078408/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-01-c.png)

</Choice>

<Choice>

![D, lie links to curly brackets which links to "bitter" with taste above the link, cake links to curly brackets which links to "bitter" with taste above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613078466/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-01-d.png)
...
![A, lie links to curly brackets which links to "butter" with taste above the link, cake links to curly brackts which link to "bitter" with taste above the link, both curly brackets are linked with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613078949/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-03-a.png)

</Choice>

<Choice>

![B, lie links to curly brackets which links to "butter" with taste above the link, cake links to curly brackts which link to "butter" with taste above the link, both curly brackets are linked with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079013/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-03-b.png)

</Choice>

<Choice correct>

![C, lie links to curly brackets which links to "butter" with taste above the link, cake links to curly brackets which link to the first curly brackets with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079031/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-03-c.png)

</Choice>

<Choice>

![D, lie and cake link to the same curly brackets which links to "butter" with taste above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079057/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-03-d.png)
...
![A, spider links to curly brackets which links to 8 with legs above the link, miles links to curly brackts which link to 8 with legs above the link, both curly brackets are linked with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079341/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-05-a.png)

</Choice>

<Choice correct>

![B, spider links to curly brackets which links to 8 with legs above the link, miles links to curly brackts which link to 2 with legs above the link, both curly brackets are linked with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079368/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-05-b.png)

</Choice>

<Choice>

![C, spider links to curly brackets which links to 2 with legs above the link, miles links to curly brackts which link to 2 with legs above the link, both curly brackets are linked with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079393/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-05-c.png)

</Choice>

<Choice>

![D, spider links to curly brackets which links to 8 with legs above the link, miles links to curly brackts which links to the first curly brackets with __proto__ above the link](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613079418/just-javascript-email-images/jj09/Quiz%20Images/jjs-09-05-d.png)
