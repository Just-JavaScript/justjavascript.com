<Article title="Equality of Values" series={1} episode={7}>
...
<Answer byline="Don’t reveal until you have finished writing.">
...
If you struggle with this idea, you might want to revisit _Counting the Values_ and [work through the exercises for it again](https://eggheadio.typeform.com/to/STEeMy?email={{subscriber.email_address}}). It _will_ make sense, I promise!
...
<Answer byline="Don’t reveal until you have finished sketching and writing.">
...
Once you've completed [the exercises](https://eggheadio.typeform.com/to/wpQKI4?email={{subscriber.email_address}}) I will send you the next email.

Cheers,  
Dan

<Pagination next="08-properties" prev="06-meeting-objects-and-functions">
  Properties
</Pagination>
