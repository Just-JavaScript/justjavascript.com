export const meta = {
    ...
    series: 1,
    episode: 2,
    next: "03-values-and-variables",
    prev: "01-mental-models",
    nextTitle: "Values and Variables"
}
