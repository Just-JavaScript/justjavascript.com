export const meta = {title: 'Mental Models', series: 1, episode: 1}
...
(By the way, `a` being `0` and `b` being `10` _is_ the correct answer.)
...
Please [click here to send feedback and complete a short survey](https://eggheadio.typeform.com/to/a8hLh5?email={{subscriber.email_address}}) about this module.
