<Article title="Meeting Objects and Functions" series={1} episode={6}>
...
<Answer byline="Don’t reveal until you have decided on an answer.">
...
<Pagination next="07-equality-of-values" prev="05-meeting-objects-and-functions">
  Equality of Values
</Pagination>
