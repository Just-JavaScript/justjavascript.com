<Article title="Values and Variables" series={1} episode={3} next="04-studying-from-the-inside" prev="02-the-javascript-universe" nextTitle="Studying from the Inside">
