<Article title="Studying from the Inside" series={1} episode={4} next="05-meeting-the-primitive-values" prev="03-values-and-variables" nextTitle="Meeting the Primitive Values">
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614267568/just-javascript-email-images/jj04/dream-glitch-optim-mp4.mp4" title="javascript world" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614267568/just-javascript-email-images/jj04/dream-glitch-meta-optim-mp4.mp4" title="are we in a simulation too?" />
