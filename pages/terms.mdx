...
This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from justjavascript.com (the “Site”).
...
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at team@justjavascript.com
...
export default ({ children }) => (
  <Layout meta={{ title: 'Terms and Conditions' }}>
    <div className="sm:py-40 py-32 px-8 max-w-screen-md mx-auto min-h-screen flex flex-col items-center justify-center">
      <div className="prose prose-serif relative z-10 px-5 ">{children}</div>
    </div>
  </Layout>
)
