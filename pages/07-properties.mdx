...
Importantly, properties don’t _contain_ values — they _point_ at them! It turns out that our universe is full of wires. Some of them start in our code (variables), and others start from objects (properties). All wires always point to values.
...
<Pagination next="08-mutation" prev="06-equality-of-values">
  Mutation
</Pagination>
