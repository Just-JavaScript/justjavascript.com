...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614268354/just-javascript-email-images/jj08/step1_-mp4.mp4" title="Step 1 Animation" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614268354/just-javascript-email-images/jj08/step2_v2-mp4.mp4" title="Step 2" />
...
**It’s the value itself (the object previously created with `{ city: 'London' }`) that matters during assignment, not how we found it (`sherlock.address`).**
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614268354/just-javascript-email-images/jj08/step3_v2-mp4.mp4" title="Step 3" />
...
<Pagination next="10-prototypes" prev="08-properties">
  Prototypes
</Pagination>
