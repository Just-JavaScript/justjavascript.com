...
Just JavaScript is a _work in progress_ that exists as a series of free emails.
...
By subscribing to updates I will add you to my email list and send a sequence of emails describing my JavaScript mental models. This will eventually be a paid course, but _you can unsubscribe at any time_.
...
export default ({children}) => {
  return (
    <Layout
      ...
      className="prose lg:prose-xl prose-lg max-w-none"
      headerContent={
