...
Let’s start at the beginning. When you were learning programming, you focused on _writing_ code. That’s what programming is, right?
...
We all guess when reading code. But to gain confidence and find that bug, you need more than that. You need to _see_ what happens as your program runs. You need to _embody_ your program. You need to _think_ in JavaScript.
...
Just JavaScript is not a course for _complete_ beginners. Yes, we will cover variables, values, and objects. But we won’t be talking about how to _use_ them. You already know that. We’ll focus on how to _think_ about them.
...
<Image
  src={SherlockDiagram}
  alt="a diagram of javascript object, using sherlock holmes as an example"
/>
...
import SherlockDiagram from '../public/sherlock-props-1@2x.jpg';
import SherlockDiagram2 from '../public/sherlock-props-2@2x.jpg';
