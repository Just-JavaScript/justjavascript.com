...
const Layout = ({children, title, header, className}) => {
  return (
    <>
      <SEO title={title} />
      <div className="max-w-screen-md mx-auto pb-24 sm:px-8 px-5">
        ...
        >
          {/* prettier-ignore */}
          <motion.svg animate={{x: [0, -16]}}  transition={{ease: 'linear', loop: Infinity, duration: 1.5}} className="mb-24 text-gray-400 mx-auto w-24" width="123" height="16" viewBox="0 0 123 16"><polyline fill="none" stroke="currentColor" strokeWidth="4" points="652.5 379 662.5 369 672.5 379 682.5 369 692.5 379 702.5 369 712.5 379 722.5 369 732.5 379 742.5 369 752.5 379 762.5 369 772.5 379" transform="translate(-651 -366)"/></motion.svg>
        </motion.div>
