...
This is why having an accurate mental model is so important; it allows you to rely on the "fast" thinking system as much as possible. Simulating a computer in your head is hard, and with the wrong mental model, all of that effort is wasted.
