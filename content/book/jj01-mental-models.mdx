...
This is why having an accurate mental model is so important; it allows you to rely on the "fast" thinking system as much as possible. Simulating a computer in your head is hard enough - the wrong mental model makes it even harder.
