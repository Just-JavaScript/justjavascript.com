...
- You can declare a variable with `const` instead of `let`. That allows you to enforce that this variable always points at the same value. But remember that `const` does *not* prevent object mutation!
