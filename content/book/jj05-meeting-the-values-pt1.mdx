...
But as we discussed in our previous module, "Studying from the Inside," we have agreed to talk about the JavaScript universe as if we lived inside of it. We won't make statements about it that we can't verify from inside the universe — by running some code.
