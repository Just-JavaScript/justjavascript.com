...
I’m standing on a small planet. This little world is my program - my code. There is a lot going on around me: I can see `if` statements, variable declarations, commas and curly braces.
My code contains instructions like “make a function call”, “do this thing many times”, or even “throw an error”. I walk through these instructions step by step, working through the code on my small planet.
