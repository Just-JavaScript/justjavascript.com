...
All primitive values have something in common: **They are a permanent part of our JavaScript universe. I can point at them, but I can't create, destroy, or change them.**
...
**Objects and functions** are are also values but, unlike primitve values, **I can manipulate them from my code**. If primitive values are like distant stars, then objects and functions are more like asteroids floating around my planet. They're not part of my code, but they're close enough to manipulate.

// "FUN FACT" POP-OUT
Functions are objects, but because they include a few additional features, we’re going to refer to them separately to avoid confusion.
// "FUN FACT" POP-OUT
