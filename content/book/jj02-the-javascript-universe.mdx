...
To distinguish values from all of the other code in my JavaScript program, I like to imagine this drawing of the Little Prince by Antoine de Saint-Exupéry:
