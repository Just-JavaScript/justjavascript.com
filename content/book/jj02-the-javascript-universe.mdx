...
This is like asking what a number or letter is. **A value is an *element* in our JavaScript universe.** Numbers and letters are values. Things like objects and functions can be values, too.
