...
[Click here to answer these questions](https://eggheadio.typeform.com/to/PLyTKB?email={{subscriber.email_address}}) and provide feedback about this module. _When you complete the exercises I will send the next module right away._
