...
When I ask our universe a question, it answers with a value. I certainly didn’t come up with all these values myself. The variables, the expressions, the values — they all populate our world. The JavaScript world around me is absolutely real to me.
