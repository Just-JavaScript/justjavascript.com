...
In the previous module, we’ve looked at primitive values: Undefined, Null, Booleans, Numbers, Strings and BigInts. We will now introduce ourselves to types that let us *make our own values*:.
