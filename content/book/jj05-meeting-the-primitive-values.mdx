...
Before continuing our tour of the JavaScript universe, let's check our mental model. Open a [sketching app](https://www.excalidraw.com/) or take a piece of paper, and sketch out the variables (remember to think of them as wires) and the values for the above snippet of code.
...
This module is split in two parts. Now that we've met all of the primitive values, we’ll take a small break from our tour. Let’s recap the primitive values we’ve encountered so far!
