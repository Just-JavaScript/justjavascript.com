...
**Objects and functions** are are also values but, unlike primitive values, **I can manipulate them from my code**. If primitive values are like distant stars, then objects and functions are more like asteroids floating around my planet. They’re not part of my code, but they’re close enough to manipulate.
...
“I see,” you might reply, “this is because *everything* is an object!” Alas, this is a [popular urban legend](https://www.google.com/search?q=%22in%20javascript%20everything%20is%20an%20object%22), but it’s not true.

Although code like `"hi".toUpperCase()` makes `"hi"` seem like an object, this is nothing but an illusion.
JavaScript creates a temporary object when you do this, and then immediately discards it. It’s fine if this mechanism doesn’t click for you yet. It is indeed rather confusing!
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614256341/just-javascript-email-images/jj02/typeof-mp4.mp4" title="Using typeof" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614256341/just-javascript-email-images/jj02/expression-mp4.mp4" title="Expression" />
