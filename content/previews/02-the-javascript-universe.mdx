...
We can break values down into types—values of the same type behave in similar ways. As an aspiring astronomer, you might want to know about _every_ type of value that can be observed in the JavaScript sky.
...
“I see,” you might reply, “this is because _everything_ is an object!” Alas, this is a [popular urban legend](https://www.google.com/search?q=%22in%20javascript%20everything%20is%20an%20object%22), but it’s not true.
...
<Video
  src="https://res.cloudinary.com/dg3gyk0gu/video/upload/f_auto/just-javascript-email-images/jj02/typeof-mp4.mp4"
  title="Using typeof"
/>
...
<Video
  src="https://res.cloudinary.com/dg3gyk0gu/video/upload/f_auto/just-javascript-email-images/jj02/expression-mp4.mp4"
  title="Expression"
/>
