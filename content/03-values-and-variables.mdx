<Article title="Values and Variables" series={1} episode={3} next="04-studying-from-the-inside" nextTitle="Studying from the Inside" prev="02-the-javascript-universe" bottomContent={`This module also has exercises for you to practice!\n\n**Don’t skip them!**\n\nEven though you’re likely familiar with the concept of variables, these exercises will help you cement the mental model we’re building. We need this foundation before we can get to more complex topics.`}>
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614257600/just-javascript-email-images/jj03/narwhal-assignment-mp4.mp4" title="Assigning the value 'Narwhal' value to the name pet" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614257817/just-javascript-email-images/jj03/kraken-reassignment-mp4.mp4" title="Assigning the value 'The Kraken' to the name pet" />
...
2. **The right side of an assignment must be an expression, so it always results in a value.** Our expression can be something simple, like `2` or `'hello'`. It can also be a more complicated expression—for example:
  ...
  Here, `count + ' Dalmatians'` is an expression—a question to JavaScript. JavaScript will answer it with a value (for example, `"101 Dalmatians"`). From now on, the `pet` variable “wire” will point to that partiular value.
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614257335/just-javascript-email-images/jj03/assign-step1-mp4.mp4" title="let x = 10" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614257335/just-javascript-email-images/jj03/assign-step2-mp4.mp4" title="let y = x" />
...
<Video src="https://res.cloudinary.com/dg3gyk0gu/video/upload/v1614257336/just-javascript-email-images/jj03/assign-step3-mp4.mp4" title="x = 0" />
