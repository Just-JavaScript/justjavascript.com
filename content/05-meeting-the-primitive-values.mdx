<Article title="Meeting the Primitive Values" series={1} episode={5} next="06-meeting-objects-and-functions" prev="04-study-from-the-inside" nextTitle="Meeting Objects and Functions">
