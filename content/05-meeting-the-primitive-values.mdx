...
But as we discussed in [Studying from the Inside](/learn/04-studying-from-the-inside), we have agreed to talk about the JavaScript universe as if we lived inside of it. We won’t make statements about it that we can’t verify from inside the universe—by running some code.
