<Article title="Mental Models" series={1} episode={1} next="02-the-javascript-universe" nextTitle="The JavaScript Universe" bottomContent={`In the next module, we’ll start building mental models for some of the most fundamental JavaScript concepts—values and expressions.`} >
